...
When this is set you will be able to expand archive filenames with `C-o'
...
That's mean:
First hit on C-o expand CANDIDATE second hit open file.
If a prefix arg is given or `helm-follow-mode' is on open file."
  (let* ((follow        (or (buffer-local-value
    ...
    (cond ((and (helm-ff-invalid-tramp-name-p)
          ...
          ;; An image file and it is the second hit on C-o,
